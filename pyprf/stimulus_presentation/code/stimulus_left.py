...
# Modifications made to lines 688-710 to present bar stimuli on the left half of 
...
# left half of the screen. The aperture is enabled before drawing the stimulus bar, 
...
#############################################################################################
                ...
                objAprtr = visual.Aperture(
                    objWin,
                    size=varDegCov,
                    shape=left_half_vertices,    # left half screen draw only for the grating
                    pos=(0, 0),
                    inverted=False,
                    units='deg')
